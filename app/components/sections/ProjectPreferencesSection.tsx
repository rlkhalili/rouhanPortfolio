...
export function ProjectPreferencesSection({ items }: ProjectPreferencesSectionProps) {
  return (
    <article
    ...
    >
      <h2 className="text-2xl font-semibold text-zinc-900 dark:text-white">Projects I take on</h2>
