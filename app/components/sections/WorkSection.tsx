    ...
    >
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-2">
        {projects.map((project) => {
          const content = (
            <article className="flex h-full flex-col gap-4 rounded-2xl border border-zinc-200 bg-white/80 p-5 transition hover:-translate-y-1 hover:border-zinc-900 dark:border-zinc-800 dark:bg-zinc-900/70 dark:hover:border-zinc-100">
          ...
          return project.href ? (
            <Link
              key={project.title}
              href={project.href}
              className="group block focus:outline-none focus-visible:ring-2 focus-visible:ring-black/70 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-white/80 dark:focus-visible:ring-offset-zinc-900"
            >
              {content}
            </Link>
          ) : (
